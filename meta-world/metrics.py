"""All numeric-metric computation for the continual MetaWorld benchmark.
...
def build_retention_matrix(args, suite, condition, seed, device):
    ...
    for seq_idx, trained_task in enumerate(args.task_sequence):
        ...
        rows = {metric: [] for metric in ("return", "success", "task_error", "evaluation_interactions", "adaptation_interactions")}
