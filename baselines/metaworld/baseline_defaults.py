"""Suite-specific defaults for the baseline runner. META-WORLD COPY.
...
than the method is not a comparison.
    ...
    run_sac.Args.task_suite       = "mw_easy4"
    run_sac.Args.total_timesteps  = 150_000
...
The sequence is 8 positions over 4 unique tasks, (0, 2, 3, 1, 0, 3, 2, 1).
Positions 0-2 are Continual World triplet #3 verbatim; every task appears
exactly twice with varied repeat gaps, so the retention matrix says something
about forgetting as a function of distance.
"""
from __future__ import annotations

import tasks

DEFAULT_TASK_SUITE = "mw_easy4"
...
#: Seeds for the continual chains, matching run_kaggle.sh's Meta-World stage.
DEFAULT_SEEDS = (1, 2, 3)
