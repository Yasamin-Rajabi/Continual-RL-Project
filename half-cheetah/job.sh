...
#SBATCH --output=logs/hc-main_%j.out
#SBATCH --error=logs/hc-main_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
EXPERIMENT_ROOT="${EXPERIMENT_ROOT:-artifacts/ethos_student_halfcheetah_windvel_80k}"
...
echo "[done] survey metrics (including FT): $RUN_ROOT/plots/halfcheetah_wind_vel/survey_metrics.csv"
