...
#SBATCH --output=logs/hc-scratch_%j.out
#SBATCH --error=logs/hc-scratch_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "============================================================"
echo "[scratch] environment: HalfCheetah-WindVel"
echo "[scratch] mode:        $EVAL_MODE"
echo "[scratch] seed:        $SCRATCH_SEED"
echo "[scratch] suite:       halfcheetah_wind_vel"
