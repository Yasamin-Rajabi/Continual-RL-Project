...
# MiniGrid is a new benchmark in this integration, so there are no historical
# pre-lineage/pre-alpha-mass checkpoint fingerprints to grandfather in.
PRE_LINEAGE_BALANCING_SOURCE_FINGERPRINTS = set()
PRE_ALPHA_MASS_LR_SOURCE_FINGERPRINTS = set()
...
def runtime_versions() -> dict:
    result = {}
    for package in ("python", "torch", "numpy", "gymnasium", "minigrid", "stable-baselines3"):
        if package == "python":
            import sys
