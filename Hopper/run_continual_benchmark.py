...
def parse_args():
    ...
    p.add_argument("--save-root", default="agents_hopper")
    p.add_argument("--runs-root", default="runs")
    p.add_argument("--plots-root", default="plots_hopper_continual")
    ...
    if args.quick_test:
        ...
        args.task_suites = ["hopper_dynamics"]
        args.seeds = [1]
