...
#SBATCH --output=logs/cka_w2d_150k_%j.out
#SBATCH --error=logs/cka_w2d_150k_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Output directories
# ------------------------------------------------------------
RUN_ROOT="artifacts/cka_walker2d_150k"
...
echo "============================================================"
echo "[job] CKA-RL Walker2D benchmark"
...
echo "[train] timesteps/task: 150000"
